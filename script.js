        ...
        <div class="nav-wrap">
            <nav>
                ...
                <a class="leiste" href="warenkorb.html">
                  ...
                  <span id="warenkorb-anzahl">99</span>
...
function updateWarenkorbAnzahl() {
  const warenkorbAnzahlElement = document.getElementById("warenkorb-anzahl");
  const warenkorb = JSON.parse(localStorage.getItem("warenkorb")) || [];
  const gesamtAnzahl = warenkorb.reduce(
    (summe, item) => summe + item.anzahl,
    0,
  );
  warenkorbAnzahlElement.textContent = gesamtAnzahl;

  setTimeout(updateWarenkorbAnzahl, 50);
}
